<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_staff.aspx.cs" Inherits="personal_portfolio.add_staff" %>
               ...
               <div class="container">
                   <div class="form">
                       ...
                       <div class="inputbox" >
                           ...
                           <asp:Button ID="button1" runat="server" CssClass="style" Text="Add Staff 🧑‍🏫" ForeColor="White" BackColor="Blue" Width="340px "/>
                       </div>

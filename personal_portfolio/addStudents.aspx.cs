                        ...
                        if (IsValidEmail(email))
                        {
                            ...
                            if (password.Equals(Cpassword))
                            {
                                if (IsValidPassword(password))
                                {
                                    ...
                                    cmd = new SqlCommand("insert into Approved_account_student_tbl (First_Name,Last_Name,Email,Image) values('" + txt_fnm.Text + "','" + txt_lnm.Text + "','" + txt_eml.Text + "','" + imageUrl + "') ", con);

                                    cmd.ExecuteNonQuery();
                                    ErrorMessageLabel2.Text = "  Student Added successfully..  ";
                                }
                                else
                                {
